...
public partial class GameContext {
    ...
    public GameEntity SetTime(float newDelta, float newScale) {
        if (hasTime) {
        ...
        entity.AddTime(newDelta, newScale);
        return entity;
    }

    public void ReplaceTime(float newDelta, float newScale) {
        var entity = timeEntity;
        if (entity == null) {
            entity = SetTime(newDelta, newScale);
        } else {
            entity.ReplaceTime(newDelta, newScale);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTime(float newDelta, float newScale) {
